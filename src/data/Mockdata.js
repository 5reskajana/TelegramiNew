...
export const MOCK_TELEGRAMS = [
  {
    ...
    body: "Further to our meeting on Tuesday, please review the attached reallocation proposal for Q1. Finance requires your sign-off no later than end of business Friday.",
  ...
  },
  {
    ...
    body: "Please be advised that the revised staff leave policy will come into effect on the 1st of April. All department heads are requested to brief their teams accordingly.",
  ...
  },
  {
    ...
    body: "This is to confirm the warehouse inspection has been scheduled for 15 March at 10:00. Please ensure all documentation is prepared in advance.",
  ...
  },
  {
    ...
    body: "Please find attached the draft presentation for the Annual Operations Review. Feedback is requested before the 20th of March.",
  ...
  },
  {
    ...
    body: "Following our recent discussions, I have begun drafting a proposal for the restructuring of the operations team.",
  ...
  },
  {
    ...
    body: "Attached is the February fleet maintenance report. Two vehicles require immediate attention.",
  ...
  },
  {
    ...
    body: "Please find enclosed the operational expenditure forecast for March.",
    priority: "NORMAL", status: "DELIVERED", classification: "INTERNAL",
  ...
  },
  {
    ...
    body: "Legal has completed its review of the third-party vendor contracts due for renewal in April.",
  ...
  },
  {
    ...
    body: "This draft outlines preliminary considerations for Q2 operations planning.",
  ...
  },
  {
    ...
    body: "Please find attached the year-end financial summary for the Operations Division.",
    priority: "NORMAL", status: "READ", classification: "CONFIDENTIAL",
